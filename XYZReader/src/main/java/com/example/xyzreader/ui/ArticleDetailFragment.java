...
public class ArticleDetailFragment extends Fragment implements
    ...
    private DynamicImageView mPhotoView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPhotoView = (DynamicImageView) mRootView.findViewById(R.id.photo);
            ...
            Picasso.with(getActivity()).load( mCursor.getString(ArticleLoader.Query.PHOTO_URL))
                    ...
                    into(mPhotoView, new Callback() {
                        ...
                        public void onSuccess() {
                            dynamicColor(mPhotoView,(LinearLayout) mRootView.findViewById(R.id.meta_bar));
                        }
    ...
    /*ideas gotten from http://tutorialsbuzz.com/2015/11/android-collapsingtoolbarlayout-example_7.html
        ...
        */
    private void dynamicColor(ImageView imageView, final LinearLayout linearLayout ) {
        ...
        Palette.from(bitmap).generate(new Palette.PaletteAsyncListener() {
            ...
            public void onGenerated(Palette palette) {
                ...
                linearLayout.setBackgroundColor(palette.getDarkMutedColor(0XFF5233));
            }
        });
    }
}
